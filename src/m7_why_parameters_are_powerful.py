...
def run_test_draw_circles():
    ...
    # ------------------------------------------------------------------
    # Students:
    #   Do NOT touch this function - it has no T0D0 in it.
    # ------------------------------------------------------------------
    print()
    print('--------------------------------------------------')
...
def better_draw_circles(r):
    """
        ...
        -- Constructs and draws 21 rg.Circle objects such that:
             -- Each is centered at (200, 200)
             -- They have radii:  0  r  2r  3r  4r ... 20r, respectively.
             -- Pauses 0.05 seconds after rendering each.
        -- Waits for the user to press the mouse, then closes the window.
        """
    # ------------------------------------------------------------------
...
def run_test_even_better_draw_circles():
    ...
    print('Testing  better_draw_circles:  See graphics window')
    print('--------------------------------------------------')
    even_better_draw_circles(5, 40, 'pink')
    even_better_draw_circles(10, 25, 'purple')
    even_better_draw_circles(15, 15, 'violet')


def even_better_draw_circles(r, n, c):
    """
        -- Constructs a window whose width and height are both 400.
        -- Constructs and draws n+1 rg.Circle objects with outline color c such that:
             -- Each is centered at (200, 200)
             -- They have radii:  0  r  2r  3r  4r ... 20r, respectively.
             -- Pauses 0.05 seconds after rendering each.
        -- Waits for the user to press the mouse, then closes the window.
